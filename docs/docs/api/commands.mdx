...
description: Complete command-line interface reference for hayate send, hayate receive, and hayate discover — all flags, options, and examples.
---
...
| Flag              | Description                                          | Default        |
| ----------------- | ---------------------------------------------------- | -------------- |
| `--peer <ADDR>`   | Equivalent to positional `TARGET`                    | none           |
| `--code <PHRASE>` | Pairing code for LAN discovery                       | auto-generated |
| `-z, --compress`  | Zstd compression (level 1)                           | `true`         |
| `--hash <ALGO>`   | Integrity algorithm: `blake3`, `rapidhash`, `sha256` | `blake3`       |
